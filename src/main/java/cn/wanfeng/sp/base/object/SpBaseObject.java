...
public class SpBaseObject implements ISpBaseObject {
    ...
    private static final int CREATE_DATE_INDEX = 4;
    private static final int MODIFY_DATE_INDEX = 5;
    private static final int IS_DELETE_INDEX = 6;

    private static final ProtoType ID_PROTO_TYPE = ProtoType.LONG;
    private static final ProtoType NAME_PROTO_TYPE = ProtoType.STRING;
    ...
    public SpBaseObject(SpSession session, Long id) {
        ...
        LogUtils.info(objectDO.getModifyDate().toString());
